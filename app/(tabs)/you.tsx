...
const styles = StyleSheet.create({
  ...
  avatarText: { fontSize: 31, color: "#fff", fontFamily: typography.extraBold },
  /* avatarCamera: {
    position: "absolute",
    right: 4,
    bottom: 4,
...
fontFamily: typography.bold,
    ...
    color: "#fff",
    fontSize: 24,
    fontFamily: typography.regular, lineHeight: 30,
...
fontFamily: typography.bold,
  ...
  backgroundTitle: {
fontFamily: typography.semibold, color: colors.white, fontSize: 16, fontFamily: typography.bold, fontFamily: typography.bold },
  backgroundSub: { color: colors.muted, fontSize: 12, fontFamily: typography.regular, marginTop: 3 },
  previewWrap: {
    width: "100%",
    height: 170,
  ...
  chooseButtonText: {
fontFamily: typography.semibold, color: colors.black, fontSize: 15, fontFamily: typography.bold, fontFamily: typography.bold },
