...
fontFamily: typography.bold,
  ...
  backgroundTitle: {
fontFamily: typography.semibold, color: colors.white, fontSize: 16, fontFamily: typography.bold, fontWeight: "700" },
  ...
  chooseButtonText: {
fontFamily: typography.semibold, color: colors.black, fontSize: 15, fontFamily: typography.bold, fontWeight: "700" },
