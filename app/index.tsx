...
const styles=StyleSheet.create({
  ...
  greeting:{fontFamily:typography.medium,color:colors.white,fontSize:34,lineHeight:40,fontFamily:typography.medium,letterSpacing:-0.8},
  title:{fontFamily:typography.regular,color:'rgba(255,255,255,0.88)',fontSize:21,lineHeight:27,fontFamily:typography.regular,letterSpacing:-0.2,marginTop:2},
  avatarText:{fontFamily:typography.bold,color:colors.white,fontSize:17,fontFamily:typography.bold},
  eventsSection:{marginTop:10},
  sectionRow:{flexDirection:'row',alignItems:'center',justifyContent:'space-between'},
  seeAll:{fontFamily:typography.semibold,color:'rgba(220,225,232,0.82)',fontSize:14,fontFamily:typography.semibold,marginBottom:12},
  seeArrow:{fontFamily:typography.regular,fontSize:23,fontFamily:typography.regular,color:'rgba(220,225,232,0.82)'},
  ...
  eventName:{fontFamily:typography.extraBold,color:colors.white,fontSize:16,fontFamily:typography.extraBold,letterSpacing:-.2},
  eventMeta:{fontFamily:typography.regular,color:'rgba(255,255,255,0.72)',fontSize:11,marginTop:4},
  emptyTitle:{fontFamily:typography.bold,color:colors.white,fontSize:16,fontFamily:typography.bold},
