...
const styles=StyleSheet.create({
  ...
  greeting:{fontFamily:typography.medium,color:colors.white,fontSize:34,lineHeight:40,fontWeight:'500',letterSpacing:-0.8},
  title:{fontFamily:typography.regular,color:'rgba(255,255,255,0.88)',fontSize:21,lineHeight:27,fontWeight:'400',letterSpacing:-0.2,marginTop:2},
  avatarText:{fontFamily:typography.bold,color:colors.white,fontSize:17,fontWeight:'700'},
  eventsSection:{marginTop:10},
  sectionRow:{flexDirection:'row',alignItems:'center',justifyContent:'space-between'},
  seeAll:{fontFamily:typography.semibold,color:'rgba(220,225,232,0.82)',fontSize:14,fontWeight:'600',marginBottom:12},
  seeArrow:{fontFamily:typography.regular,fontSize:23,fontWeight:'300',color:'rgba(220,225,232,0.82)'},
  ...
  eventName:{fontFamily:typography.extraBold,color:colors.white,fontSize:16,fontWeight:'800',letterSpacing:-.2},
  eventMeta:{fontFamily:typography.regular,color:'rgba(255,255,255,0.72)',fontSize:11,marginTop:4},
  emptyTitle:{fontFamily:typography.bold,color:colors.white,fontSize:16,fontWeight:'700'},
