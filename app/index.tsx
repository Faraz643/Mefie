...
const styles=StyleSheet.create({
  ...
  grid:{flexDirection:'row',flexWrap:'wrap',justifyContent:'space-between',columnGap:8,rowGap:12,marginHorizontal:-4},
  eventCard:{width:'49%',height:170,borderRadius:radii.card,overflow:'hidden',backgroundColor:'#26313F',...shadows},
