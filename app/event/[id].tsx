...
const PLACEHOLDER_PHOTOS = [
  'https://images.unsplash.com/photo-1500534623283-312aade485b7?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1511497584788-876760111969?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1493246507139-91e8fad9978e?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1470770841072-f978cf4d019e?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1495567720989-cebdbdd97913?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1526481280695-3c687fd5432c?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1521292270410-a8c4d716d518?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1526772662000-3f88f10405ff?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1530789253388-582c481c54b0?auto=format&fit=crop&w=700&q=88','https://images.unsplash.com/photo-1500534623283-312aade485b7?auto=format&fit=crop&w=700&q=82&sat=-12','https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=700&q=82&sat=12','https://images.unsplash.com/photo-1501785888041-af3ef2852c3b?auto=format&fit=crop&w=700&q=82&sat=-8','https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=700&q=82&sat=8','https://images.unsplash.com/photo-1470770841072-f978cf4d019e?auto=format&fit=crop&w=700&q=82&sat=-10','https://images.unsplash.com/photo-1493246507139-91e8fad9978e?auto=format&fit=crop&w=700&q=82&sat=10'
];
  ...
  return (
    <View style={styles.root}>
      <View pointerEvents="none" style={styles.background}>
        ...
        <LinearGradient colors={['rgba(4,9,14,.02)', 'rgba(4,9,14,.08)', 'rgba(8,16,23,.72)']} locations={[0, 0.48, 1]} style={StyleSheet.absoluteFillObject} />
      </View>
      <Animated.ScrollView
        style={styles.scroll}
...
const styles = StyleSheet.create({
  ...
  tabsSticky: { height: TAB_HEIGHT + 8, paddingHorizontal: 20, paddingTop: 4, paddingBottom: 4, backgroundColor: 'transparent', zIndex: 10 },
  tabs: { width: '100%', height: TAB_HEIGHT, borderRadius: 27, backgroundColor: 'transparent', borderWidth: 0, flexDirection: 'row' },
  tab: { flex: 1, borderRadius: 24, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 },
  activeTab: { backgroundColor: 'rgba(255,255,255,.98)', borderWidth: 1, borderColor: 'rgba(255,255,255,.94)', shadowColor: '#fff', shadowOpacity: 0.28, shadowRadius: 6, shadowOffset: { width: 0, height: 1 }, elevation: 3 },
  tabText: { color: 'rgba(255,255,255,.90)', fontSize: 14, fontWeight: '700' },
  activeTabText: { color: colors.black, fontSize: 14, fontWeight: '800' },
  gallery: { paddingHorizontal: 10, paddingTop: 0, backgroundColor: 'transparent', minHeight: 900 },
