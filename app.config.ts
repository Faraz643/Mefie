export default ({ config }: { config: any }) => ({
  ...
  expo: {
    ...
    plugins: [
      'expo-router',
      'expo-asset',
      ['expo-camera', { cameraPermission: 'Mefie needs camera access to capture shared moments.' }],
      ['expo-image-picker', { photosPermission: 'Mefie needs photo access to save and share your moments.' }],
      ['expo-media-library', { photosPermission: 'Mefie needs photo access to save your shared moments.', savePhotosPermission: 'Mefie needs permission to save shared moments to your photo library.' }]
    ],
