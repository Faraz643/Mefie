export default ({ config }: { config: any }) => ({
  ...
  expo: {
    ...
    plugins: ['expo-router', ['expo-camera', { cameraPermission: 'Mefie needs camera access to capture shared moments.' }], ['expo-image-picker', { photosPermission: 'Mefie needs photo access to save and share your moments.' }]],
