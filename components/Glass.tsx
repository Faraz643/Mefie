...
const styles = StyleSheet.create({
  ...
  actionTitle: { fontFamily: typography.bold, color: "rgba(255,255,255,0.96)", fontSize: 16, fontWeight: "700", letterSpacing: -0.2 },
  actionTitlePrimary: { color: colors.black },
  actionSubtitle: { fontFamily: typography.regular, color: colors.muted, fontSize: 12, marginTop: 3 },
  ...
  buttonLabel: { fontFamily: typography.bold, color: colors.white, fontSize: 15, fontWeight: "700", flex: 1 },
  ...
  inputLabel: { fontFamily: typography.semibold, color: "rgba(255,255,255,0.88)", fontSize: 12, marginBottom: 3, fontWeight: "600" },
  ...
  sectionTitle: { fontFamily: typography.bold, color: colors.white, fontSize: 20, fontWeight: "800", marginBottom: 3, letterSpacing: -0.3 },
