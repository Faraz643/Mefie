...
const styles = StyleSheet.create({
  ...
  action: { height: 80, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.18)', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, overflow: 'hidden', ...shadows },
