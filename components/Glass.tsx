...
const styles = StyleSheet.create({
  ...
  actionTitle: { fontFamily: typography.bold, color: "rgba(255,255,255,0.96)", fontSize: 16, fontFamily: typography.bold, fontWeight: "700", letterSpacing: -0.2 },
  actionTitlePrimary: { color: colors.black },
  actionSubtitle: { fontFamily: typography.regular, color: colors.muted, fontSize: 12, fontFamily: typography.regular, marginTop: 3 },
  ...
  buttonLabel: { fontFamily: typography.bold, color: colors.white, fontSize: 15, fontFamily: typography.bold, fontWeight: "700", flex: 1 },
  ...
  inputLabel: { fontFamily: typography.semibold, color: "rgba(255,255,255,0.88)", fontSize: 12, fontFamily: typography.regular, marginBottom: 3, fontWeight: "600" },
  input: { fontFamily: typography.regular, color: colors.white, fontSize: 16, paddingVertical: 3, paddingHorizontal: 0, minHeight: 26, backgroundColor: "transparent", borderWidth: 0 },
  sectionTitle: { fontFamily: typography.bold, color: colors.white, fontSize: 20, fontFamily: typography.extraBold, fontWeight: "800", marginBottom: 3, letterSpacing: -0.3 },
