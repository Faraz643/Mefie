...
const styles = StyleSheet.create({
  ...
  actionTitle: { fontFamily: typography.bold, color: "rgba(255,255,255,0.96)", fontSize: 16, letterSpacing: -0.2 },
  ...
  buttonLabel: { fontFamily: typography.bold, color: colors.white, fontSize: 15, flex: 1 },
  ...
  inputLabel: { fontFamily: typography.semibold, color: "rgba(255,255,255,0.88)", fontSize: 12, marginBottom: 3 },
  ...
  sectionTitle: { fontFamily: typography.extraBold, color: colors.white, fontSize: 20, marginBottom: 3, letterSpacing: -0.3 },
